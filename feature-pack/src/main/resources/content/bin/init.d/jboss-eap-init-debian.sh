#!/bin/sh
#
# /etc/init.d/jboss-eap -- startup script for JBossEAP
#
...
# Default-Stop:         0 1 6
# Short-Description:    JBossEAP Application Server
# Description:          Provide JBossEAP startup/shutdown script
### END INIT INFO

NAME=jboss-eap
DESC="JBossEAP Application Server"
...
# Make sure jboss-eap is started with system locale
...
# Launch jboss-eap in background
LAUNCH_JBOSS_IN_BACKGROUND=1
export LAUNCH_JBOSS_IN_BACKGROUND

# Helper function to check status of jboss-eap service
check_status() {
