...
public class HornetQBackupActivationTestCase {
    ...
    public void initServer() throws Exception {
        ...
        liveJMSOperations = JMSOperationsProvider.getInstance(createLiveClient());
        backupJMSOperations = JMSOperationsProvider.getInstance(createBackupClient());
    }
    ...
    private void waitForBackupServerToReload(int timeout) throws Exception {
        ...
        do {
            ...
            try {
                ...
                if (normal) {
                    backupJMSOperations = JMSOperationsProvider.getInstance(backupClient);
                    return;
                }
            } catch (Exception e) {
            }
    ...
    private void waitForLiveServerToReload(int timeout) throws Exception {
        ...
        do {
            ...
            try {
                ...
                boolean normal = "running".equals(result.get(RESULT).asString());
                if (normal) {
                    liveJMSOperations = JMSOperationsProvider.getInstance(liveClient);
                    return;
                }
            } catch (Exception e) {
            }
