...
public class MigrateOperation implements OperationStepHandler {
    ...
    private static final AttributeDefinition ENABLE_LEGACY = SimpleAttributeDefinitionBuilder.create("enable-legacy", BOOLEAN)
    ...
    public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
        ...
        boolean enableLegacy = ENABLE_LEGACY.resolveModelAttribute(context, operation).asBoolean();
        ...
        context.addStep(new OperationStepHandler() {
            ...
            public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
                ...
                transformResources(legacyModelAddOps, migrationOperations, enableLegacy);
    ...
    private void transformResources(final ModelNode legacyModelDescription, final Map<PathAddress, ModelNode> newAddOperations, boolean enableLegacy) {
                ...
                if (subsystemSubresource.getName().equals("server")) {
                    ...
                    switch (serverSubresource.getName()) {
                        case CONNECTION_FACTORY:
                            ...
                            migrateConnectionFactory(newAddOp, enableLegacy ? NEW_ENTRY_SUFFIX : "");
                            break;
