...
public interface MessagingLogger extends BasicLogger {
     ...
     */
    MessagingLogger ROOT_LOGGER = Logger.getMessageLogger(MessagingLogger.class, "org.wildfly.extension.messaging.activemq-activemq");

    /**
     * A logger with the category {@code org.jboss.messaging-activemq}.
     */
    MessagingLogger MESSAGING_LOGGER = Logger.getMessageLogger(MessagingLogger.class, "org.jboss.messaging-activemq");
     ...
     * resource. Meant for use with runtime resources available via {@link org.apache.activemq.core.server.ActiveMQServer#getManagementService()}
     *
     * @param address    the address.
     */
