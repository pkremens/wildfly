...
public class PooledConnectionFactoryService implements Service<Void> {
    ...
    private static final String HQ_ACTIVATION = "org.apache.activemq.artemis.ra.inflow.ActiveMQActivationSpec";
    private static final String HQ_CONN_DEF = "ActiveMQConnectionDefinition";
    private static final String HQ_ADAPTER = "org.apache.activemq.artemis.ra.ActiveMQResourceAdapter";
    ...
    private static final String HQ_SESSION = "org.apache.activemq.artemis.ra.ActiveMQRASession";
